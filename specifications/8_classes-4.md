...
Một trong các methods được kế thừa phải là return-type-substitutable (return type có thể thay thế) cho mỗi method được kế thừa khác; nếu không sẽ xảy ra compile-time error.
